...
alias c='claude --effort max --permission-mode plan'
alias cc='claude --effort max --permission-mode plan --continue'
alias cr='claude --effort max --permission-mode plan --resume'
